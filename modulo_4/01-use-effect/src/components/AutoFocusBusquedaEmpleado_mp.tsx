// src/components/AutoFocusBusquedaEmpleado_mp.tsx

import { useEffect, useRef } from 'react'

export default function AutoFocusBusquedaEmpleado_mp() {
  ...
  return (
    <input
      ref={inputRef}
      placeholder="Código de empleado (recibe foco automático al montar)"
      style={{
        padding: '8px 12px',
