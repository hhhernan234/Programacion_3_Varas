...
import { useHover_mp } from '../hooks/useHover_mp'

export default function HoverDemo_mp() {
  const btn1 = useHover_mp(
    {
  ...
  return (
    <div {...card.hoverProps} style={card.style}>
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        <button {...btn1.hoverProps} style={btn1.style}>Calcular nómina</button>
        <button {...btn2.hoverProps} style={btn2.style}>Ver detalle</button>
      </div>
    </div>
  )
}
