...
// Simula un cálculo costoso, como procesar la nómina de muchos empleados
...
export default function PrimeSieve_mp() {
  ...
  const primos = useMemo(() => sieve(limit), [limit])

  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 520, margin: '0 auto', padding: 24 }}>
      <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 4 }}>Cálculo Costoso - Sistema de Nóminas</h2>
