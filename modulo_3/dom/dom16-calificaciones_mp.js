// dom16-calificaciones_mp.js
// Arreglo de objetos: empleados con nombre y calificación de desempeño (0-10)
// Cálculos: promedio, calificación máxima, mínima, conteo de aprobados/reprobados


const alumnos = [];   // arreglo principal de empleados evaluados
...
function agregarAlumno() {
   ...
   if (nombre === '') {
       divError.textContent   = 'Por favor ingresa el nombre del empleado.';
...
function calcularEstadisticas() {
   ...
   if (alumnos.length === 0) {
       divError.textContent   = 'Agrega al menos un empleado antes de calcular.';
       divError.style.display = 'block';
       return;
   }
...
// Enter en los campos de ingreso agrega el empleado
window.onload = () => {
